...
foreach ($alphabet as $letter) {
	...
	echo "the total results are: " . $totalResults . "\n";

	if ($totalResults == $secretLength) {
...
for ($i = 0; $i < $secretLength; $i++) {
	...
	// Just going to be dumb about this for now

	for ($i = 0; $i < $secretLength; $i++) {

		echo "the array is: " . json_encode($res[$i]) . "\n";

		$len = sizeof($res[$i]);

		if ($len > 1) {
			echo "the length is greater than 1. " . "\n";
